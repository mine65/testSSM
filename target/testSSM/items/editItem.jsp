...
<%@ page import="com.igeek.ssm.pojo.Items" %>
...
<div class="container" style="margin-top: 100px">
	...
	<form id="f" action="${pageContext.request.contextPath}/items/update.action" method="post" enctype="multipart/form-data">
		<div class="form-group" hidden="hidden">
			...
			<input type="text" value="${item.id}" class="form-control" id="id" placeholder="id" name="id">
		</div>
		...
		<div class="form-group">
			...
			<img src="${items.pic}" id="pic" name="pic" width="100" height="100" />
		...
		<div class="form-group">
			...
			<input type="date" value="${Datestr}" class="form-control" id="createtime" placeholder="createtime" name="createtime">
		</div>
